        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 md:h-20">
            ...
            <div className="hidden lg:flex items-center space-x-6">
              <a href="https://www.a-w.ch" className="text-gray-700 hover:text-slate-900 transition-colors font-medium text-sm">
                Portfolio
              </a>
              <a href="https://www.a-w.ch/artist" className="text-gray-700 hover:text-slate-900 transition-colors font-medium text-sm">
                The Artist
              </a>
              <a href="https://www.a-w.ch/contact-us" className="text-gray-700 hover:text-slate-900 transition-colors font-medium text-sm">
                Contact
              </a>
              {/* Social Links */}
              <div className="flex items-center space-x-3 ml-4 pl-4 border-l border-gray-200">
                <a href="https://www.instagram.com/wehrliantonio/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg hover:bg-gray-100 flex items-center justify-center transition-all group">
                  <svg className="w-5 h-5 text-gray-600 group-hover:text-slate-900" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://twitter.com/wehrliantonio" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg hover:bg-gray-100 flex items-center justify-center transition-all group">
                  <svg className="w-5 h-5 text-gray-600 group-hover:text-slate-900" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/>
                  </svg>
                </a>
                <a href="https://www.linkedin.com/in/antoniowehrli/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg hover:bg-gray-100 flex items-center justify-center transition-all group">
                  <svg className="w-5 h-5 text-gray-600 group-hover:text-slate-900" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                  </svg>
                </a>
                <a href="https://web.facebook.com/AntonioWehrliArtSpace" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg hover:bg-gray-100 flex items-center justify-center transition-all group">
                  <svg className="w-5 h-5 text-gray-600 group-hover:text-slate-900" fill="currentColor" viewBox="0 0 24 24">
              ...
              {connected && publicKey ? (
                ...
                <button 
                  ...
                  className="px-4 md:px-5 py-1.5 md:py-2 rounded-lg bg-slate-900 hover:bg-slate-800 text-white text-xs md:text-sm font-semibold transition-all"
                >
          ...
          <div className="lg:hidden border-t border-gray-200 bg-white">
            <div className="px-4 py-4 space-y-4">
              <a 
                ...
                className="block text-gray-700 hover:text-slate-900 transition-colors font-medium py-2 text-sm"
              ...
              <div className="pt-4 border-t border-gray-200">
                {connected && publicKey ? (
                  ...
                  <button 
                    ...
                    className="w-full px-6 py-2 rounded-lg bg-slate-900 hover:bg-slate-800 text-white font-semibold transition-all text-sm"
                  >
                    Connect Wallet
                  </button>
                )}
      ...
      <main className="pt-20 md:pt-24 pb-8 md:pb-12 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12 md:mb-16">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 md:mb-6 text-slate-900 px-4">
